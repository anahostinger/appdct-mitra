...
$(document).ready(function(){
    ...
    _getScript("frame-first-investor");
    _getScript("frame-login-investor");
    _getScript("frame-home-investor");
    _getScript("frame-profil-investor");
    _getScript("frame-reset-investor");
